...
class TestCourse(TestCase):
    ...
    def setUp(self):
        self.CS361 = Course.objects.create(CourseId="123", name = "Introduction to Software Engineering", number = "361", subject="CS")
    ...
    def test_course_delete(self):
        test = Course.deleteCourse(CourseId="123", name="Introduction to Software Engineering", number="361", subject="CS")
        lookup = list(Course.objects.all())
